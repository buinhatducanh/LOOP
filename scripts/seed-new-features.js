 ...
 * Run: node scripts/seed-new-features.js
 */
...
async function main() {
  ...
  for (const faq of faqs) {
    ...
    if (!existing) {
      ...
      console.log(`  ⏭  ️FAQ exists: ${faq.question.slice(0, 50)}...`);
    }
  }
  ...
  const jobs = [
    ...
    },
    {
      ...
      salaryMin: 12000000,
      salaryMax: 20000000,
      description: "Sáng tạo nội dung cho brand LOOP Solutions và khách hàng. Bạn sẽ viết blog, quản lý social media, sản xuất nội dung video ngắn và tham gia vào các chiến dịch marketing của agency.\n\n**Công việc cụ thể:**\n- Viết bài blog chuyên sâu về digital marketing, tech, design\n- Quản lý và lên kế hoạch content cho social media (Facebook, LinkedIn, TikTok)\n- Sản xuất content video ngắn (15-60s) cho social platforms\n- Collaborate với design team để tạo visual content\n- Research trends và competitive analysis",
  ...
  for (const project of projects) {
    ...
    if (!existing) {
      ...
      console.log(`  ✅ Case study: ${project.title}`);
    } else {
  ...
  console.log("\n✅ Seeding complete!");
  console.log("\nNext steps:");
  console.log("1. Visit /admin/faq to review FAQ items");
  console.log("2. Visit /admin/careers to review job postings");
  console.log("3. Visit /admin/case-studies to review case study projects");
  console.log("4. Run: npx prisma migrate deploy  (for production)");
}
