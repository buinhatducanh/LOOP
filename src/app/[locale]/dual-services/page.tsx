...
import { DualServicesPage } from "./dual-services-page";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://loop.vn/${locale}/dual-services` },
  };
}
...
export default async function Page({
  ...
  return <DualServicesPage locale={locale} templates={templates} attributes={attributes} />;
}
