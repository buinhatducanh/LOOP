...
// Fix Windows bug: webpack bundles @vercel/og with broken font URL on Windows.
// e.g. '.\file:\D:\WEB\...' instead of 'file:///D:/WEB/...'
// Patch global URL to auto-correct this before ImageResponse uses it.
export const runtime = "nodejs";

if (process.platform === "win32") {
  const _OrigURL = globalThis.URL;
  class FixedURL extends _OrigURL {
    constructor(url: string | URL, base?: string | URL) {
      if (typeof url === "string" && /^\.[/\\]file:[/\\]/.test(url)) {
        url = url.replace(/^\.[/\\]file:[/\\]+/, "file:///").replace(/\\/g, "/");
      }
      super(url, base);
    }
  }
  (globalThis as unknown as Record<string, unknown>).URL = FixedURL;
}
