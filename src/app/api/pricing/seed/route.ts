...
import { ok, serverError, unauthorized, forbidden } from "@/lib/api";
        ...
        data: {
          ...
          features: {
            create: group.features.map((f) => ({
              ...
              isActive: f.isActive,
              variants: {
                create: f.variants.map((v: { variantName: string; description?: string; price: number; sortOrder: number }) => ({
    ...
    features: [
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Giỏ hàng cơ bản, hiển thị sản phẩm cơ bản", price: 0, sortOrder: 1 },
        ],
      },
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Mã giảm giá chung, tính phí ship đồng giá", price: 2000000, sortOrder: 1 },
          { variantName: "Flash Sale có đồng hồ đếm ngược, Mua combo (Combo discount)", price: 4000000, sortOrder: 2 },
          { variantName: "Hệ thống Tích điểm đổi quà, Ví tiền ảo nội bộ (Credit system)", price: 8000000, sortOrder: 3 },
        ],
      },
    ],
  },
    ...
    features: [
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Kho lưu trữ hình ảnh cơ bản", price: 0, sortOrder: 1 },
          { variantName: "Kho lưu trữ hình ảnh + video", price: 2000000, sortOrder: 2 },
          { variantName: "Hình ảnh video Full HD, banner động", price: 4000000, sortOrder: 3 },
          { variantName: "Hình ảnh video Full HD, banner động, tối ưu tự động (WebP)", price: 8000000, sortOrder: 4 },
        ],
      },
    ],
  },
    ...
    features: [
      {
        ...
        isActive: true,
        variants: [
          { variantName: "1 tài khoản Admin toàn quyền", price: 0, sortOrder: 1 },
          { variantName: "Phân quyền cơ bản (Admin, Editor)", price: 2000000, sortOrder: 2 },
          { variantName: "Role-Based Access Control: Cấp quyền chi tiết (chỉ xem, được sửa) cho Sale, Kho", price: 4000000, sortOrder: 3 },
          { variantName: "Workflow: Nhân viên đăng sản phẩm -> Quản lý duyệt -> Xuất bản", price: 8000000, sortOrder: 4 },
        ],
      },
    ],
  },
    ...
    features: [
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Danh sách đơn hàng", price: 0, sortOrder: 1 },
          { variantName: "Thống kê tổng doanh thu đơn giản", price: 2000000, sortOrder: 2 },
          { variantName: "Biểu đồ doanh thu trực quan, thống kê sản phẩm bán chạy", price: 4000000, sortOrder: 3 },
          { variantName: "Lịch sử thao tác của nhân viên (Log hệ thống), Báo cáo chiết khấu", price: 8000000, sortOrder: 4 },
        ],
      },
    ],
  },
    ...
    features: [
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Đăng ký mới", price: 350000, sortOrder: 1 },
        ],
      },
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Đăng ký mới", price: 850000, sortOrder: 1 },
        ],
      },
      {
        ...
        isActive: true,
        variants: [
          { variantName: "Cơ bản (2GB - 3GB)", price: 800000, sortOrder: 1 },
          { variantName: "Nâng cao (5GB - 10GB)", price: 1800000, sortOrder: 2 },
        ],
      },
    ],
  },
