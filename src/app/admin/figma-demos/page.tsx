...
interface FigmaDemo {
  id: string; projectId: string; title: string; figmaUrl: string;
  versionHash: string | null; status: string; clientEmail: string | null;
  clientToken: string; rejectionNote: string | null; sentAt: string | null;
  createdAt: string;
  project: { id: string; orderNumber: string; customerName: string };
}

export default function FigmaDemosStandalonePage() {
