...
function OrderDetailModal({ order, onClose }: { order: Order | null; onClose: () => void }) {
 ...
 style={{ display: "flex", alignItems: "center", gap: 6, padding: "6px 14px", borderRadius: 8, border: "none", cursor: "pointer", fontSize: 12, fontFamily: DS.mono, fontWeight: activeTab === tab.key ? 700 : 400,
...
export default function OrdersPage() {
 ...
 <button onClick={() => setEditOrder({} as Order)}
