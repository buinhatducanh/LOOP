 ...
 * Migrated from FE/src/app/hooks/useRealtimeNotifications.ts
 */
...
const LIVE_POOL: NotifTemplate[] = [
  {
    type: "new_order",
    title: "📦 Đơn mới — MindfulTech 120M VNĐ",
  ...
  {
    type: "payment",
    title: "💳 Thanh toán — GreenTech 68M VNĐ",
  ...
  {
    type: "media_booking",
    title: "📸 Booking media — Café Artisanal",
  ...
  {
    type: "task",
    title: "✅ Task hoàn thành — Design System v2",
  ...
  {
    type: "escalation",
    title: "🔴 Escalation — FintechPro yêu cầu khẩn",
