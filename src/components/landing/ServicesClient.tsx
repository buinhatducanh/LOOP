...
const CUSTOM_SERVICES: CustomService[] = [
  {
    ...
    desc: "Website chuyên nghiệp, tối ưu SEO, responsive trên mọi thiết bị. Đội ngũ thiết kế 5 năm kinh nghiệm.",
    features: [
      "Giao diện hiện đại theo brand",
  ...
  },
  {
    ...
    desc: "Công cụ hỗ trợ nội bộ, quản lý dữ liệu, tự động hóa quy trình cho doanh nghiệp với chi phí hợp lý.",
    features: [
  ...
  },
  {
    ...
    desc: "10 bài chuẩn SEO theo doanh nghiệp (có sẵn assets). Tăng trưởng organic bền vững, content marketing toàn diện.",
    features: [
      "10 bài chuẩn SEO theo doanh nghiệp",
      "Assets có sẵn — giao nhanh",
      "30 bài/tháng: 600,000 VNĐ",
      "Gói 6 tháng: giảm 10%",
      "Gói 1 năm: giảm 20%",
      "Gói 2 năm: giảm 30%",
    ],
        ...
        {activeTab === "tabPricing" && (
          ...
          >
            <div style={{ maxWidth: 1024, margin: "0 auto" }}>
              ...
              >
                {[
                  { name: ui.planStarter, price: "1,980,000", sub: ui.planStarterSub, features: ui.planStarterFeatures, cta: ui.planStartNow, lp: 750, popular: false, color: DS.text4 },
                  { name: ui.planBusiness, price: "19,980,000", sub: ui.planBusinessSub, features: ui.planBusinessFeatures, cta: ui.planChooseBusiness, lp: 2250, popular: true, color: DS.blue },
