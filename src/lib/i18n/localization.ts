...
export function mapLocalizedProject<T extends LocalizedRecord>(
  ...
  return {
    ...
    isCaseStudy: record["isCaseStudy"] ?? record["is_case_study"],
    industry: record["industry"],
    primaryMetric: record["primaryMetric"] ?? record["primary_metric"],
    roiMetric: record["roiMetric"] ?? record["roi_metric"],
    sortOrder: record["sortOrder"] ?? record["sort_order"],
    createdAt: record["createdAt"] ?? record["created_at"],
    updatedAt: record["updatedAt"] ?? record["updated_at"],
    _localeUsed: locale,
...
export function mapLocalizedBlogPost<T extends LocalizedRecord>(
  ...
  return {
    ...
    backlinks: record["backlinks"] ?? record["backlinks"],
