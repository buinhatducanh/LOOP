...
| 2026-03-30 | R-seed | Re-seed: Unified Demo Data | pending | completed | FE | Re-seed COMPLETE (2026-03-30). R2: 27 team members seeded (upsert, 26 updated), 15 team User accounts created (for QuestParticipant FK), 37 member-expertise links, 12 rank effects, 6 member effect overrides, 6 portfolio projects, 5 demo orders + OrderStatusHistory, 6 ProjectMember links, 27 CustomerPoints, 105 LpTransactions, 2 Epics + 20 Tasks (Kanban), 60 quest/event participations. Fixes: Haru Tanaka added to memberData (id=14), DEMO_USERS LP/level synced with memberData canonical values, INIT_ADMIN_NOTIFS timestamps fixed (SEED_NOW), INIT_OVERRIDES memberId corrected. tsc✅ build✅. | low | N/A | N/A | fe-reseed-plan.md, prisma/seed.ts, FE/src/app/components/team/memberData.ts, FE/src/app/store/authStore.ts, FE/src/app/store/loopStore.ts |
