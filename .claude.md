...
### 8. Tuyệt đối KHÔNG sử dụng lệnh `code`

KHÔNG BAO GIỜ được gửi hoặc chạy lệnh `code <tên_file>` trong môi trường terminal để mở file. Lệnh này sẽ gây lỗi mở sai ứng dụng. Thay vào đó, bạn chỉ cần báo hoàn thành, không cần tự tiện bật file ra.
