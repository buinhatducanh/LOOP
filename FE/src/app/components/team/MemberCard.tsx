...
export function CornerDeco({ color, opacity = 1 }: { color: string; opacity?: number }) {
...
// ── Diamond prismatic particles (đa sắc: indigo + cyan + pink + white) ────
...
// ── Diamond lăng kính — tia sáng quét chéo prismatic ──────────────────────
const PRISM_BEAMS = [
      ...
      <div style={cardStyle}>
        ...
        <div className="relative" style={{ paddingBottom: '110%' }}>
          ...
          <div className="absolute bottom-3 left-3 z-20 flex items-baseline gap-1">
            ...
            >
              <Counter value={member.level} duration={1.2} delay={0.1} />
            </span>
        ...
        <div className="px-3 pt-2 pb-3">
          ...
          <div className="mt-2.5">
            <div className="flex justify-between mb-1" style={{ color: '#475569', fontSize: 9, fontFamily: "'JetBrains Mono', monospace" }}>
              <span style={{ color: cfg.color }}>XP <Counter value={xpPct} duration={1.2} delay={0.2} />%</span>
              <span>
                {member.currentXP}/{member.maxXP}
              </span>
            </div>
...
// ── Export box shadow anim map for admin use ─────────────────────────────
export { BOX_SHADOW_ANIM };