...
// ── Member Row ────────────────────────────────────────────────────────────────
const MemberRow = forwardRef<HTMLDivElement, {
  m: typeof members[0]; rank: number; maxLP: number; isMe: boolean; onView: () => void;
}>(function MemberRow({ m, rank: pos, maxLP, isMe, onView }, ref) {
  const rc = RANKS[m.rank];
