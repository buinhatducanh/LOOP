...
async function seedServices() {
  ...
  const services = [
    ...
    },
    {
      ...
      titleEn: 'Dashboard & SaaS',
      shortDescription: 'Hệ thống quản trị, dashboard phân tích, phần mềm SaaS theo yêu cầu doanh nghiệp.',
      shortDescriptionEn: 'Admin systems, analytics dashboards, custom SaaS software for enterprises.',
      ...
      longDescriptionEn: 'Build internal management systems, KPI analytics dashboards, mini ERP, CRM with modern UI and visual reporting.',
      features: ['Analytics real-time', 'Data visualization', 'Role-based access', 'Export reports', 'Multi-tenant', 'API integrations'],
      featuresEn: ['Real-time analytics', 'Data visualization', 'Role-based access', 'Report export', 'Multi-tenant', 'API integrations'],
    ...
    },
    {
      ...
      shortDescriptionEn: 'Full-service SEO, Google Ads, and marketing to boost traffic and conversions.',
      ...
      longDescriptionEn: 'Comprehensive SEO from technical, content, to off-page. Effective Google Ads campaigns with optimized costs.',
      features: ['Audit SEO', 'On-page optimization', 'Content strategy', 'Backlink building', 'Google Ads', 'Analytics setup'],
      featuresEn: ['SEO audit', 'On-page optimization', 'Content strategy', 'Backlink building', 'Google Ads', 'Analytics setup'],
