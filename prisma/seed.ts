...
async function seedPricing() {
  ...
  // ── Website Packages (ServicePackage) — 4 gói theo wizard ─────────────────
  // Đồng bộ với 4 gói trong BookingWizardClient: landing/ban-hang/doanh-nghiep/yeu-cau
  const websitePackages = [
    {
      ...
      features: [
        ...
        "Trang giới thiệu SP/Dịch vụ",
        "Admin quản lý bài viết",
        "Form thu thập dữ liệu KH",
        "Quản lý tệp KH cơ bản",
        "Tối ưu SEO On-page",
      ],
      tagline: "Chiến dịch Marketing, giới thiệu cá nhân, offline",
      taglineVi: "Chiến dịch Marketing, giới thiệu cá nhân, offline",
      color: "#6EB1A8",
      pages: "8",
      pagesVi: "8",
      isPopular: false,
    ...
    },
    {
      ...
      features: [
        ...
        "SP nâng cao (size, màu, thuộc tính)",
        "Hệ thống Mã giảm giá/Flash sale",
        "Tích điểm & Đổi quà thành viên",
        "Bộ lọc & Tìm kiếm AI thông minh",
        "Quản lý Kho hàng & Nhà cung cấp",
      ],
      tagline: "Doanh nghiệp vừa và lớn, quản lý phức tạp",
      taglineVi: "Doanh nghiệp vừa và lớn, quản lý phức tạp",
      color: "#8B5CF6",
      pages: "8",
      pagesVi: "8",
      marketPrice: 5890000,
    ...
    },
    {
      ...
      features: [
        ...
        "Tùy chỉnh chức năng Core System",
        "Tích hợp Cổng thanh toán/Vận chuyển",
        "API kết nối bên thứ 3 (Zalo, App...)",
        "Bảo mật đa lớp & Tối ưu Speed cực hạn",
      ],
      tagline: "Startups, platform, logic đặc thù riêng",
      taglineVi: "Startups, platform, logic đặc thù riêng",
      color: "#EC4899",
      pages: "8",
      pagesVi: "8",
      marketPrice: 7890000,
  ...
  for (const p of websitePackages) {
    try {
      ...
      console.error("  ❌ Package failed:", p.slug, String(e).slice(0, 200));
    }
  }
  console.log("  ✓ Website Packages (ServicePackage)");
  ...
  const hostingPlans = [
    // ── GÓI KHỞI ĐẦU (540k/tháng) ──────────────────────────────────────────
    {
      slug: "khoi-dau-1m", name: "Khởi Đầu (1 Tháng)", nameVi: "Khởi Đầu (1 Tháng)",
      monthlyPrice: 540000, period: "1 tháng", periodVi: "1 tháng", months: 1, discountPct: 0,
      features: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 20GB SSD", "Băng thông 50GB/tháng"],
      featuresVi: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 20GB SSD", "Băng thông 50GB/tháng"],
      highlighted: false, color: "#3B82F6", sortOrder: 1,
    },
    {
      slug: "khoi-dau-6m", name: "Khởi Đầu (6 Tháng)", nameVi: "Khởi Đầu (6 Tháng)",
      monthlyPrice: 540000, period: "6 tháng", periodVi: "6 tháng", months: 6, discountPct: 0,
      features: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 20GB SSD", "Băng thông 50GB/tháng"],
      featuresVi: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 20GB SSD", "Băng thông 50GB/tháng"],
      highlighted: false, color: "#3B82F6", sortOrder: 2,
    },
    {
      slug: "khoi-dau-1y", name: "Khởi Đầu (1 Năm)", nameVi: "Khởi Đầu (1 Năm)",
      monthlyPrice: 540000, period: "1 năm", periodVi: "1 năm", months: 12, discountPct: 10,
      features: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 20GB SSD", "Băng thông 50GB/tháng", "🎁 Giảm ngay 10%"],
      featuresVi: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 20GB SSD", "Băng thông 50GB/tháng", "🎁 Giảm ngay 10%"],
      highlighted: false, color: "#3B82F6", sortOrder: 3,
    },
    {
      slug: "khoi-dau-2y", name: "Khởi Đầu (2 Năm)", nameVi: "Khởi Đầu (2 Năm)",
      monthlyPrice: 540000, period: "2 năm", periodVi: "2 năm", months: 24, discountPct: 15,
      features: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 25GB SSD", "Băng thông 100GB/tháng", "🎁 Giảm ngay 15%"],
      featuresVi: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 25GB SSD", "Băng thông 100GB/tháng", "🎁 Giảm ngay 15%"],
      highlighted: false, color: "#3B82F6", sortOrder: 4,
    },
    {
      slug: "khoi-dau-3y", name: "Khởi Đầu (3 Năm)", nameVi: "Khởi Đầu (3 Năm)",
      monthlyPrice: 540000, period: "3 năm", periodVi: "3 năm", months: 36, discountPct: 18,
      features: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 30GB SSD", "Băng thông 150GB/tháng", "🎁 Giảm ngay 18%"],
      featuresVi: ["💡 Nhân viên tập sự túc trực", "🎯 Phù hợp web mới chạy", "🚀 Đảm bảo cửa hàng luôn mở cửa", "Lưu trữ 30GB SSD", "Băng thông 150GB/tháng", "🎁 Giảm ngay 18%"],
      highlighted: false, color: "#3B82F6", sortOrder: 5,
    },

    // ── GÓI TIÊU CHUẨN (918k/tháng) ────────────────────────────────────────
    {
      slug: "tieu-chuan-1m", name: "Tiêu Chuẩn (1 Tháng)", nameVi: "Tiêu Chuẩn (1 Tháng)",
      monthlyPrice: 918000, period: "1 tháng", periodVi: "1 tháng", months: 1, discountPct: 0,
      features: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 50GB SSD", "Băng thông không giới hạn"],
      featuresVi: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 50GB SSD", "Băng thông không giới hạn"],
      highlighted: true, color: "#10B981", sortOrder: 6,
    },
    {
      slug: "tieu-chuan-6m", name: "Tiêu Chuẩn (6 Tháng)", nameVi: "Tiêu Chuẩn (6 Tháng)",
      monthlyPrice: 918000, period: "6 tháng", periodVi: "6 tháng", months: 6, discountPct: 0,
      features: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 50GB SSD", "Băng thông không giới hạn"],
      featuresVi: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 50GB SSD", "Băng thông không giới hạn"],
      highlighted: true, color: "#10B981", sortOrder: 7,
    },
    {
      slug: "tieu-chuan-1y", name: "Tiêu Chuẩn (1 Năm)", nameVi: "Tiêu Chuẩn (1 Năm)",
      monthlyPrice: 918000, period: "1 năm", periodVi: "1 năm", months: 12, discountPct: 10,
      features: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 50GB SSD", "Băng thông không giới hạn", "🎁 Giảm ngay 10%"],
      featuresVi: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 50GB SSD", "Băng thông không giới hạn", "🎁 Giảm ngay 10%"],
      highlighted: true, color: "#10B981", sortOrder: 8,
    },
    {
      slug: "tieu-chuan-2y", name: "Tiêu Chuẩn (2 Năm)", nameVi: "Tiêu Chuẩn (2 Năm)",
      monthlyPrice: 918000, period: "2 năm", periodVi: "2 năm", months: 24, discountPct: 15,
      features: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 60GB SSD", "Băng thông không giới hạn", "🎁 Giảm ngay 15%"],
      featuresVi: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 60GB SSD", "Băng thông không giới hạn", "🎁 Giảm ngay 15%"],
      highlighted: true, color: "#10B981", sortOrder: 9,
    },
    {
      slug: "tieu-chuan-3y", name: "Tiêu Chuẩn (3 Năm)", nameVi: "Tiêu Chuẩn (3 Năm)",
      monthlyPrice: 918000, period: "3 năm", periodVi: "3 năm", months: 36, discountPct: 18,
      features: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 80GB SSD", "Băng thông không giới hạn", "🎁 Giảm ngay 18%"],
      featuresVi: ["⭐ Khuyên dùng", "💡 Nhân viên Marketing chuyên nghiệp", "🎯 Dành cho web bán hàng ổn định", "Mượt mà, phản hồi nhanh", "Lưu trữ 80GB SSD", "Băng thông không giới hạn", "🎁 Giảm ngay 18%"],
      highlighted: true, color: "#10B981", sortOrder: 10,
    },

    // ── GÓI NÂNG CAO (1.836k/tháng) ───────────────────────────────────────
    {
      slug: "nang-cao-1m", name: "Nâng Cao (1 Tháng)", nameVi: "Nâng Cao (1 Tháng)",
      monthlyPrice: 1836000, period: "1 tháng", periodVi: "1 tháng", months: 1, discountPct: 0,
      features: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 100GB NVMe SSD"],
      featuresVi: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 100GB NVMe SSD"],
      highlighted: false, color: "#8B5CF6", sortOrder: 11,
    },
    {
      slug: "nang-cao-6m", name: "Nâng Cao (6 Tháng)", nameVi: "Nâng Cao (6 Tháng)",
      monthlyPrice: 1836000, period: "6 tháng", periodVi: "6 tháng", months: 6, discountPct: 0,
      features: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 100GB NVMe SSD"],
      featuresVi: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 100GB NVMe SSD"],
      highlighted: false, color: "#8B5CF6", sortOrder: 12,
    },
    {
      slug: "nang-cao-1y", name: "Nâng Cao (1 Năm)", nameVi: "Nâng Cao (1 Năm)",
      monthlyPrice: 1836000, period: "1 năm", periodVi: "1 năm", months: 12, discountPct: 10,
      features: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 100GB NVMe SSD", "🎁 Giảm ngay 10%"],
      featuresVi: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 100GB NVMe SSD", "🎁 Giảm ngay 10%"],
      highlighted: false, color: "#8B5CF6", sortOrder: 13,
    },
    {
      slug: "nang-cao-2y", name: "Nâng Cao (2 Năm)", nameVi: "Nâng Cao (2 Năm)",
      monthlyPrice: 1836000, period: "2 năm", periodVi: "2 năm", months: 24, discountPct: 15,
      features: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 120GB NVMe SSD", "🎁 Giảm ngay 15%"],
      featuresVi: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 120GB NVMe SSD", "🎁 Giảm ngay 15%"],
      highlighted: false, color: "#8B5CF6", sortOrder: 14,
    },
    {
      slug: "nang-cao-3y", name: "Nâng Cao (3 Năm)", nameVi: "Nâng Cao (3 Năm)",
      monthlyPrice: 1836000, period: "3 năm", periodVi: "3 năm", months: 36, discountPct: 18,
      features: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 150GB NVMe SSD", "🎁 Giảm ngay 18%"],
      featuresVi: ["🔥 Tốc độ siêu nhanh", "💡 Trưởng nhóm (Manager) đầy kinh nghiệm", "🎯 Chịu tải tốt khi chạy Ads", "Xử lý mượt lượng khách lớn", "Lưu trữ 150GB NVMe SSD", "🎁 Giảm ngay 18%"],
      highlighted: false, color: "#8B5CF6", sortOrder: 15,
    },

    // ── GÓI DOANH NGHIỆP (3.366k/tháng) ────────────────────────────────────
    {
      slug: "doanh-nghiep-1m", name: "Doanh Nghiệp (1 Tháng)", nameVi: "Doanh Nghiệp (1 Tháng)",
      monthlyPrice: 3366000, period: "1 tháng", periodVi: "1 tháng", months: 1, discountPct: 0,
      features: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 300GB NVMe SSD"],
      featuresVi: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 300GB NVMe SSD"],
      highlighted: false, color: "#EC4899", sortOrder: 16,
    },
    {
      slug: "doanh-nghiep-6m", name: "Doanh Nghiệp (6 Tháng)", nameVi: "Doanh Nghiệp (6 Tháng)",
      monthlyPrice: 3366000, period: "6 tháng", periodVi: "6 tháng", months: 6, discountPct: 0,
      features: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 300GB NVMe SSD"],
      featuresVi: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 300GB NVMe SSD"],
      highlighted: false, color: "#EC4899", sortOrder: 17,
    },
    {
      slug: "doanh-nghiep-1y", name: "Doanh Nghiệp (1 Năm)", nameVi: "Doanh Nghiệp (1 Năm)",
      monthlyPrice: 3366000, period: "1 năm", periodVi: "1 năm", months: 12, discountPct: 10,
      features: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 300GB NVMe SSD", "🎁 Giảm ngay 10%"],
      featuresVi: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 300GB NVMe SSD", "🎁 Giảm ngay 10%"],
      highlighted: false, color: "#EC4899", sortOrder: 18,
    },
    {
      slug: "doanh-nghiep-2y", name: "Doanh Nghiệp (2 Năm)", nameVi: "Doanh Nghiệp (2 Năm)",
      monthlyPrice: 3366000, period: "2 năm", periodVi: "2 năm", months: 24, discountPct: 15,
      features: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 500GB NVMe SSD", "🎁 Giảm ngay 15%"],
      featuresVi: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 500GB NVMe SSD", "🎁 Giảm ngay 15%"],
      highlighted: false, color: "#EC4899", sortOrder: 19,
    },
    {
      slug: "doanh-nghiep-3y", name: "Doanh Nghiệp (3 Năm)", nameVi: "Doanh Nghiệp (3 Năm)",
      monthlyPrice: 3366000, period: "3 năm", periodVi: "3 năm", months: 36, discountPct: 18,
      features: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 1TB NVMe SSD", "🎁 Giảm ngay 18%"],
      featuresVi: ["🏢 Phòng ban Marketing chuyên nghiệp", "🎯 Sàn TMĐT, giao dịch liên tục", "Hệ thống luôn hoàn hảo", "Chịu tải truy cập đột biến", "Lưu trữ 1TB NVMe SSD", "🎁 Giảm ngay 18%"],
      highlighted: false, color: "#EC4899", sortOrder: 20,
    },
  ];
